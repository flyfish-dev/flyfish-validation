...
import dev.flyfish.validation.validator.NumericValueValidator;

/** 数字文本。空值默认有效，必填请组合标准约束。 */
@Documented
...
public @interface NumericValue {
    String message() default "{dev.flyfish.validation.constraints.NumericValue.message}";
