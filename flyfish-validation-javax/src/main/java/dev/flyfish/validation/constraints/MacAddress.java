...
import dev.flyfish.validation.validator.MacAddressValidator;

/** MAC 地址。空值默认有效，必填请组合标准约束。 */
@Documented
...
public @interface MacAddress {
    String message() default "{dev.flyfish.validation.constraints.MacAddress.message}";
