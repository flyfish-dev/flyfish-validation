...
import dev.flyfish.validation.validator.IpAddressValidator;

/** IP 地址。空值默认有效，必填请组合标准约束。 */
@Documented
...
public @interface IpAddress {
    String message() default "{dev.flyfish.validation.constraints.IpAddress.message}";
