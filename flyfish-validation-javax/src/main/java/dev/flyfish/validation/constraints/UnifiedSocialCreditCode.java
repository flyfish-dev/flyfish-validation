...
import dev.flyfish.validation.validator.UnifiedSocialCreditCodeValidator;

/** 统一社会信用代码。空值默认有效，必填请组合标准约束。 */
@Documented
...
public @interface UnifiedSocialCreditCode {
    String message() default "{dev.flyfish.validation.constraints.UnifiedSocialCreditCode.message}";
