...
import dev.flyfish.validation.validator.TimePatternValidator;

/** 严格时间格式。空值默认有效，必填请组合标准约束。 */
@Documented
...
public @interface TimePattern {
    String message() default "{dev.flyfish.validation.constraints.TimePattern.message}";
