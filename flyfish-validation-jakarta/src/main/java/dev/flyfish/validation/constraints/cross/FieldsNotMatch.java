...
import dev.flyfish.validation.validator.cross.FieldsNotMatchValidator;
...
@Repeatable(FieldsNotMatch.List.class)
@Constraint(validatedBy = FieldsNotMatchValidator.class)
public @interface FieldsNotMatch {

    String message() default "{dev.flyfish.validation.constraints.cross.FieldsNotMatch.message}";
