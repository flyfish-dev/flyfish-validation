...
import dev.flyfish.validation.validator.DomainNameValidator;

/** 互联网域名（支持 IDN）。空值默认有效，必填请组合标准约束。 */
@Documented
...
public @interface DomainName {
    String message() default "{dev.flyfish.validation.constraints.DomainName.message}";
